...
<div class="page-content bg-white">
    ...
    <div class="content-block">
        ...
        <!-- Form -->
        <div class="section-area section-sp1 ovpr-dark bg-fix online-cours" style="background-image:url('/public/admin/assets/images/background/bg1.jpg');">
            <div class="container">
                <div class="row">
        ...
        <!-- Testimonials -->
        <div class="section-area section-sp2 bg-fix ovbl-dark" style="background-image:url(/public/admin/assets/images/background/bg1.jpg);">
            <div class="container">
                <div class="row">
